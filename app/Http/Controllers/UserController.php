...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $v = $request->validate([
            ...
            'password'=>['required','string',\Illuminate\Validation\Rules\Password::defaults(),'confirmed'],'role'=>'required|in:admin,manager,staff,viewer',
    ...
    public function update(Request $request, User $user)
    {
        $v = $request->validate([
            ...
            'password'=>['nullable','string',\Illuminate\Validation\Rules\Password::defaults(),'confirmed'],'role'=>'required|in:admin,manager,staff,viewer',
            'warehouse_id'=>'nullable|exists:warehouses,id|required_if:role,staff','is_active'=>'boolean',
        ]);
        $old = $user->toArray();
