        ...
        <AuthenticatedLayout title="Edit User"><Head title="Edit User" />
            ...
            <FormCard onSubmit={e=>{e.preventDefault();put(`/users/${user.id}`);}} processing={processing} submitLabel="Perbarui">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <FormField label="Role *"><Select value={data.role} onChange={e=>setData('role',e.target.value)} options={[{value:'admin',label:'Admin'},{value:'manager',label:'Manager'},{value:'staff',label:'Staff'},{value:'auditor',label:'Auditor'}]}/></FormField>
