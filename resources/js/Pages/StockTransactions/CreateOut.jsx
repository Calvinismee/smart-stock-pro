...
export default function CreateOut({ products, warehouses }) {
    const { data, setData, post, processing, errors } = useForm({ product_id:'',warehouse_id:warehouses.length===1?warehouses[0].id:'',quantity:'',transaction_date:new Date().toISOString().split('T')[0],notes:'' });
    return (
